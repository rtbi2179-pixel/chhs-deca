        ...
        <div className={`mt-7 grid gap-7 ${focusMode ? 'lg:grid-cols-1' : 'lg:grid-cols-[minmax(17rem,0.78fr)_minmax(0,2fr)]'}`}>
          ...
          <div className="min-w-0 space-y-7">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <section className="rounded-2xl border border-blue-400/20 bg-blue-500/[0.05] p-5"><h2 className="text-lg font-semibold text-white">Find Your DECA Event</h2><p className="mt-2 text-sm leading-6 text-white/60">Not sure your current event fits? Retake the short Event Match Quiz. Your event will only change if you explicitly select a new one.</p><a href="/event-match?retake=1" className="mt-5 inline-flex h-10 items-center rounded-md border border-blue-400/35 px-4 text-sm font-medium text-blue-200 transition hover:bg-blue-500/10"><RotateCcw className="mr-2 h-4 w-4" />Retake Event Match Quiz</a></section>
