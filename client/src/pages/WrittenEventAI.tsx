...
const WRITTEN_EVENT_AI_URL = 'https://chhsdeca-9shazsx7.manus.space';
...
export default function WrittenEventAI() {
    ...
    switch (error) {
      case 'permission-denied':
        return {
          ...
          message: 'You denied microphone access. To use the Written Event AI, you may need to allow microphone access.',
          steps: [
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-foreground/70">Loading Written Event AI...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="fixed inset-0 bg-background">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm z-50">
          <div className="flex flex-col items-center gap-4">
            <div className="relative w-16 h-16">
              ...
              <div className="absolute inset-2 rounded-full border-4 border-transparent border-b-purple-500 border-l-purple-400 animate-spin" style={{ animationDirection: 'reverse' }}></div>
              {/* Center dot */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
              </div>
            </div>
            <p className="text-foreground/70 text-sm font-medium">Loading Written Event AI...</p>
          </div>
        </div>
      )}
      ...
      <iframe
        key={iframeKey}
        src={WRITTEN_EVENT_AI_URL}
        title="Written Event AI"
