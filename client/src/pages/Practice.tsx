              ...
              >
                <div className="relative flex min-h-[320px] flex-col justify-between gap-8">
                  ...
                  <div>
                    ...
                    <Link href={card.href} className={`inline-flex w-full items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-white transition-[background-color,transform] duration-200 active:scale-[0.97] ${card.buttonClass}`}>
                      Open {card.title}
