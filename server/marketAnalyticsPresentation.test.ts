...
import { buildPortfolioPolyline, filterPortfolioSnapshots } from "../client/src/lib/marketAnalytics";
...
describe("market analytics presentation", () => {
  ...
  it("filters persisted snapshots by timeframe and produces a drawable line only when sufficient history exists", () => {
